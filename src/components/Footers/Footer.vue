        ...
        <div class="row">
            ...
            <div class="col-sm-3 m-0">
                <div class="text-center">
                    ...
                    <a href="https://www.instagram.com/dolarinfo_ar/" target="_blank"><b-icon-instagram class="icon-size-s text-color-primary pointer" /></a>
